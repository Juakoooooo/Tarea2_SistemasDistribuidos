...
class MyServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendCompra = channel.unary_unary(
                '/MyService/SendCompra',
                request_serializer=service__pb2.Compra.SerializeToString,
                response_deserializer=service__pb2.MessageResponse.FromString,
                _registered_method=True)
...
class MyServiceServicer(object):
    ...
    def SendCompra(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_MyServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendCompra': grpc.unary_unary_rpc_method_handler(
                    servicer.SendCompra,
                    request_deserializer=service__pb2.Compra.FromString,
                    response_serializer=service__pb2.MessageResponse.SerializeToString,
            ),
    }
...
class MyService(object):
    ...
    def SendCompra(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/MyService/SendCompra',
            service__pb2.Compra.SerializeToString,
            service__pb2.MessageResponse.FromString,
            options,
            channel_credentials,
            insecure,
